defmodule ExLS.LanguageServer.Compilers.Xref do
  use Mix.Task

  alias ExLS.LanguageServer.Compilers.Elixir, as: E
  import ExLS.LanguageServer.Compilers.Elixir, only: [read_manifest: 2, source: 1, source: 2, module: 1]

  @shortdoc "Performs cross reference checks"
  @recursive true

  @moduledoc """
  A fork of Elixir 1.4's Xref. Major changes:

  1. Use our custom manifest from our custom Elixir compiler.
  2. Expose `unreachable/1` function as public.

  (The rest of this moduledoc is from the original file.)
  ...
  # CHANGED: Make this public
  def unreachable(pair_fun) do
    excludes = excludes()
