defmodule ExLS.Debugger.ServerTest do
  alias ExLS.Debugger.{Server, Protocol}
  ...
  doctest ExLS.Debugger.Server

  setup do
    {:ok, packet_capture} = ExLS.IOHandler.PacketCapture.start_link(self())
    Process.group_leader(Process.whereis(ExLS.Debugger.Output), packet_capture)
